package com.datatransfer.consumer.processor;
...
import com.datatransfer.aspect.DataRun;
...
//		}
	...
	private void invokeMethod(String tags,JSONArray parameter){
		Map<String, Object> map = MyApplicationContextAware.getApplicationContext();
